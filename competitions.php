...
<div class="section">
	...
	<br>
	<div style="color:white; border-style:solid; border-color: rgb(226, 109, 54); border-weight: 2px;">
		Submissions will close on <strong class="trn">February 10th, 2023</strong>. Semifinalists will be invited to conduct a short 15 min interview with the competition evaluation team between February 13th, 2023, and February 19th, 2023. The final <strong class="trn">competition will be held on March 31st, 2023</strong>
	...
	<a href="https://docs.google.com/forms/d/e/1FAIpQLScGcvXe5ioa0kCA6X9UsN-wxMntEF_qolskXs7sgE_3z3AYnA/viewform?usp=sf_link"><!-- link in here -->
    		<div class="button style">Apply Now </div>
  	</a>
	<br>
