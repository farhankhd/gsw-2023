      ...
      <section class="startup-pitch">
         ...
         <div class="white-bg">
             <p class="para light-text light-bg-dark-text" style="text-align: center"> 
               ...
               <br><strong class="light-bg-dark-text"><a href="https://www.eventora.gr/mit-gsw/">Register now</a></strong> to see these teams pitch their company and compete for a chance to win seed money.
            </p>
            <!--
            <p class="para light-text light-bg-dark-text" style="text-align: center"> 
