...
<div class="section">
	...
	<div class="row team-row text-center">
		<div class="team container col-md-6">
			...
			<li class="list-competition"> Contributions from friends, family, and mentors</li>
			<li class="list-competition"> Research and funding grants</li>
			<li class="list-competition"> Winnings from prior competitions</li>
			<li class="list-competition">Traditional debt instruments (does not include convertible notes towards equity)</li> 
		    </ul>
        	</div>   
	</div>
