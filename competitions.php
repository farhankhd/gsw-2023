      ...
      <section class="startup-pitch">
         ...
         <div class="white-bg">
             <p class="para light-text light-bg-dark-text" style="text-align: center"> 
               ...
               <br><a style="color: #00c0f2" href="https://www.eventora.gr/mit-gsw/">Register now</a> to see these teams pitch their company for a chance to win seed money to scale their startup.
            </p>
            <!--
            <p class="para light-text light-bg-dark-text" style="text-align: center"> 
