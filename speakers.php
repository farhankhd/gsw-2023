...
<div class="section">
	...
	<div class="section-header section-header-page" style="color: white">Kenyotes</div>
	<div class="row team-row text-center">
		<div class="team container col-md-6">
			<a href="https://www.linkedin.com/in/miles-barr-10401765/">
			<img class="team-picture" src="images/speaker/miles-bar.jpg"></a>
			<div class="overlay">
				<div class="team-bio">
					...
					<br>
					<br>
					<div id="idLinkedInIcon" onclick="window.open('https://www.linkedin.com/in/miles-barr-10401765/');" title="Keynote Miles Barr>in</div>
				</div>
		...
		<div class="team container col-md-6">
			...
			<div class="overlay">
				<div class="team-bio">
					...
					<br>
					<br>
					<div id="idLinkedInIcon" onclick="window.open('');" title="Keynote Andrey Zarur">in</div>
				</div>
			</div>
...
<div class="row team-expanded-bio"><span class="anchor" id="teamKyleBranchesi"></span><div class="team col-md-5 col-lg-3 text-center"><a href="#teamKyleBranchesi"><img class="team-picture" src="images/team/Kyle.jpg"></a></div><div class="col-md-7 col-lg-9"><div class="team-expanded-name">Kyle Branchesi</div><div class="team-expanded-role">Media Team: Design</div><div class="team-expanded-text">Kyle is a design researcher in the department of architecture at MIT and currently works within the MIT Self-Assembly Lab. He has worked as a designer for the Garage Museum of Contemporary Art in Moscow Russia, as an architect for His Highness Sheikh Hamdan, The Crown Prince of Dubai, and as a project manager in Shanghai China. He has a Bachelor of Architecture from the Southern California Institute of Architecture and has studied at Universität für angewandte Kunst Wien in Austria. His work has been exhibited at the Venice Biennale in Italy, The Victoria &amp; Albert Museum in London, The Royal Danish Academy of Fine Arts in Denmark and the Pompidou Center in Paris.</div></div></div>
