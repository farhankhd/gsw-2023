    ...
    <body>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-1 col-md-12 col-lg-9">
            ...
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-sm-1 col-md-6">
                <a href="https://www.kotsovolos.gr/"> <img style="max-width: 40%; height: 50%;"" src="/2023/img/sponsors/dixons.png"></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <br>
         <div class="row justify-content-center align-items-center">
          <div class="col">
            <a href=https://www.thepeoplestrust.org/"><img style="max-width: 50%; height: auto;" src="/2023/img/sponsors/tpt.png"></a>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="row justify-content-center align-items-center">
          ...
          <div class="col-sm-1 col-md-4">
            <a href="https://www.minedu.gov.gr/"><img style="max-width: 50%; height: auto;"src="/2023/img/sponsors/MinEdu.png"></a>
          </div>
          <div class="col-sm-1 col-md-4">
