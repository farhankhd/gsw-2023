...
?>
    ...
    <body>
          ...
          <div class="col-sm-1 col-md-12 col-lg-9">
            <div class="row justify-content-center align-items-center">
              <div class="col-sm-1 col-md-6">
                <a href="https://www.capitalship.gr/"><img style="max-width: 90%; height: auto;"src="/2023/img/sponsors/capital.png"></a>
              </div>
              <div class="col-sm-1 col-md-6">
                <a href="https://www.onassis.org/"> <img style="max-width: 90%; height: auto;"src="/2023/img/sponsors/onassis.png"></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-1 col-md-12 col-lg-9">
            ...
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-sm-1 col-md-4">
                <a href="https://www.kotsovolos.gr/"> <img style="max-width: 30%; height: auto;" src="/2023/img/sponsors/dixons.png"></a>
              </div>
            </div>
            <div class="row justify-content-center align-items-center">
              <div class="col-sm-1 col-md-4">
      ...
      <section>
        ...
        <div class="row white-bg logo d-flex justify-content-center">
          <div class="col-sm-1 col-md-4">
            <a href=""><img style="max-width: 55%; height: auto;" src="/2023/img/sponsors/fytorio.jpeg"></a>
          </div>
          <div class="col-sm-1 col-md-4">
        ...
        <div class="row white-bg logo d-flex justify-content-center">
          ...
          <div class="col-sm-1 col-md-4">
            <a href=""><img style="max-width: 55%; height: auto;" src="/2023/img/sponsors/step-c.jpeg"></a>
          </div>
        </div>
        <div class="row white-bg logo d-flex justify-content-center">
          <div class="col-sm-1 col-md-4">
        ...
        <div class="row white-bg logo d-flex justify-content-center">
          <div class="col-sm-1 col-md-4">
            <a href="http://www.bioacademy.gr/"><img style="max-width: 50%; height: auto;" src="/2023/img/sponsors/acad.png"></a>
          </div>
      </section>
      ...
      <section>
        ...
        <div class="row white-bg logo d-flex justify-content-center">
          <div class="col-sm-1 col-md-4">
            <a href=""><img style="max-width: 40%; height: auto;" src="/2023/img/sponsors/code-bgp.png"></a>
          </div>
        </div>
        <div class="row white-bg logo d-flex justify-content-center">
          <div class="col-sm-1 col-md-4">
