...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="/2023/index.php"><img style="height: auto;" id="logo-left" src="img/GSW_logo_white.png"></a>
                </div>
                ...
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class=""><a class="nav-link" href="/2023/speakers.php">Speakers</a></li>
                    <li class=""><a class="nav-link " href="/2023/competitions.php">Startup Competition</a></li>
                    <!--<li class="dropdown">-->
