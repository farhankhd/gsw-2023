...
<div class="container">
    <div class="row justify-content-center">
        <div class="col">
            <img style="max-width: 80%; height: auto;" src="/2023/img/workshop/perfectpitch.png"/>
        </div>
    </div>
    <br>
    <div class="row justify-content-center">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col">
            <img style="max-width: 80%; height: auto;" src="/2023/img/workshop/productdesign.png"/>
        </div>
    </div>
    <br>
    <div class="row justify-content-center">
        <div class="col-md-9">
            ...
            <p class="light-text" style="color: #131d25">
                ...
                We'll explore the value and mechanisms of rapid prototyping, so you can quickly bring your product ideas to life and test them with your customers. 
