...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <div class="row">
                <div class="col">
                    <h1 class="section-header">COMPETITIONS</h1>
                </div>
            </div>
        ...
        <section>
            <div class="white-bg" style="padding: 50px 150px 50px">
                ...
                <p class="light-text light-bg-dark-text">
                    ...
                    Full details on Eligibility Criteria can be found <a style="color: blue" href="../docs/startup-pitch-flyer.pdf">here</a> and below. 
